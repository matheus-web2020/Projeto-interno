   ...
   clicar =() => {
    ...
    render(){
        return(  
            <View>
                <Menu/>
                <Text style={{ color : '#012D54', fontWeight : 'bold', marginLeft : 25, marginTop : -50, marginBottom : 40}}>LOJA ESPECIALIZADA EM VENDAS ONLINE</Text>
                <View style={styles.fundo}>
                    ...
                    <View style={styles.container}>
                        ...
                        <TextInput style={styles.input} secureTextEntry={true} placeholder = "Digite sua senha"/>
                         ...
                         <Text style={styles.btnEntrar,{color : 'white'}}>Entrar</Text>
                         </TouchableOpacity>
